...
image:
  caption: "**Illustration of a property inference attack.** The adversary infers the effective diameter of the underlying network from the model trained to predict an unrelated property. (see below)"
  focal_point: ""
  placement: 2
  preview_only: false
...
<table>
<tr>
    <td> <img src="arxiv.png"/></td>
    <td style="width:52%;"> <img src="arxiv_degree.png"/> </td>
</tr>
<tr>
    <td>
